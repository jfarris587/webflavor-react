...
const layout =
    <React.Fragment>
      ...
      <div className="row margin-below">
        ...
        <div className="col-lg-6">
          <img src="media/img/gate.jpg" alt="grunt"/>
        </div>
      </div>
      ...
      <div className="row margin-below">
        <div className="col-lg-3">
          <img src="media/img/browser.jpg" alt="grunt"/>
        </div>

        <div className="col-lg-9">
          <h1>Browser Syncronization</h1>
          <p>Not only does WebFlavor have live-reloading for the browser while developing, but it also supports browser syncronization with the BrowserSync package. With this, multiple browsers can be open and the scrolling, clicking, and interactions will be automatically linked up in each browser.</p>

          <p>This feature can be used to multitask and test multiple responsive screen sizes at the same time in different browsers.</p>
        </div>
      </div>
      ...
      <div className="row margin-below">
        ...
        <div className="col-lg-9">
          <h1>Dev/Production Enviornment</h1>
          <p>WebFlavor's built in development and production envriornments allow for developers to create and build their projects in an automated process that removes the manual labor that existed prior to the framework. </p>

          <p>Minification, concatenation, compression of files takes place in production along with the automated versioning, and cleaning of viewectories so that the course is LMS server ready after the build. Most importantly, live localhost servers come with browser syncronization for the best development.</p>
        </div>
      </div>
    </React.Fragment>;
